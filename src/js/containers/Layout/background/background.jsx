...
const Background = ({color, setColor, setIsLoading, current_sequence, setCurrentSequnce, is_full_loading_up, setIsFullLoadingUp}) => {
...
export default connect( ({color, setColor, setIsLoading, current_sequence, setCurrentSequnce, is_full_loading_up, setIsFullLoadingUp}) => ({
	color,
	setColor,
	setIsLoading,
	current_sequence, 
